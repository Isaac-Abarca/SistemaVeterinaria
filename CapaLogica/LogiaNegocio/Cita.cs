...
namespace CapaLogica.LogiaNegocio
{
    public class Cita
    {
        ...
        protected Date cita_fecha;
        protected DateTime cita_hora;
        ...
        public Date Cita_fecha { get => cita_fecha; set => cita_fecha=value; }
        public DateTime Cita_hora { get => cita_hora; set => cita_hora=value; }
        public string Cita_estado { get => cita_estado; set => cita_estado=value; }
        #endregion

        #region GETs and SETTER's

        public Cita(int cita_id, int mascota_id, int veterinario_id, Date cita_fecha, DateTime cita_hora, string cita_estado)
        {
            Cita_id=cita_id;
        ...
        public Cita(int mascota_id, int veterinario_id, Date cita_fecha, DateTime cita_hora, string cita_estado)
        {
            Cita_id=0;
            Mascota_id=mascota_id;
            Veterinario_id=veterinario_id;
