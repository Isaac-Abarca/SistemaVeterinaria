...
namespace SistemaVeterinaria.CapaLogica.LogiaNegocio
{
    public class Tratamiento
    {
        ...
        public Tratamiento(int medicamento_id, string tratamiento_dosis, string tratamiento_observaciones, string tratamiento_estado)
        {
            Tratamiento_id=0;
        ...
        public Tratamiento(int tratamiento_id, int medicamento_id, string tratamiento_dosis,
